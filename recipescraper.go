...
func scrapeMeta(url string) RecipeMeta {
	...
	recipeMeta := RecipeMeta{Servings: servings, ServingsUnit: servingsUnit, Cuisine: cuisine,
		Course: course, Author: author, PrepTime: prepTime,
		PrepTimeUnit: prepTimeUnit, CookTime: cookTime, CookTimeUnit: cookTimeUnit,
		TotalTime: totalTime, Summary: summary, Title: title, Url: url}
...
func RecipeHandler(w http.ResponseWriter, r *http.Request) {
	...
	decoder.DisallowUnknownFields() //err := decoder.Decode(&decodedString)
